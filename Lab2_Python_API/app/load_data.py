...
def load_all_data(SessionLocal):
    load_movies(SessionLocal)
    load_links(SessionLocal)
    load_ratings(SessionLocal)
    load_tags(SessionLocal)


def load_movies(SessionLocal):
